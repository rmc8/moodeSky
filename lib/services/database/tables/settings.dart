...
class Settings extends Table {
  ...
  )(); // 'general', 'theme', 'notification', 'privacy', 'accessibility'
  TextColumn get description => text().nullable()();
  BoolColumn get isUserModifiable =>
  ...
  List<Set<Column>> get uniqueKeys => [
    {
      key,
      accountDid,
    }, // Key per account must be unique (accountDid can be null for global)
  ];
}
...
class SettingKeys {
  ...
  static const String enableMentionNotifications =
