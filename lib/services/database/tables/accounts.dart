...
class Accounts extends Table {
  ...
  TextColumn get sessionString =>
      text().nullable()(); // For app password compatibility
  ...
  TextColumn get serviceUrl =>
      text().withDefault(const Constant('https://bsky.social'))();

  // Authentication method and status
  TextColumn get loginMethod => text().withDefault(
    const Constant('oauth'),
  )(); // 'oauth' or 'app_password'
