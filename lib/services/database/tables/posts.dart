...
class Posts extends Table {
  ...
  TextColumn get facets =>
      text().nullable()(); // JSON format for links, mentions, etc.
  TextColumn get embed =>
      text().nullable()(); // JSON format for images, videos, etc.
  ...
  TextColumn get userRepostUri =>
      text().nullable()(); // User's repost URI if reposted
  ...
  TextColumn get deckType =>
      text().nullable()(); // Which deck this post belongs to
  TextColumn get deckIdentifier =>
      text().nullable()(); // Specific deck identifier (e.g., list URI)
